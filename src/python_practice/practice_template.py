...
print("substring from index 2-3", )
print("substring alternative chars", )
print("split the string on char", )
print("last 3 chars", )
print("replace char at index 3", )
print("reverse the string", )
print("convert to list", )
print("sort using ascii", )
